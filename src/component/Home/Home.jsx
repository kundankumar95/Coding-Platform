  ...
  return (
    <div className="home-container">
        ...
        <div className="plans-carousel">
          ...
          <div className="plan-item">
            <h3>Striver’s DSA Playlist</h3>
            <p>Master algorithms effortlessly with our curated DSA playlist.</p>
            <button className="cta-btn">Try it free</button>
          </div>
          <div className="plan-item">
            <h3>CS Subjects</h3>
          ...
          <div className="plan-item">
            <h3>Striver’s CP Sheet</h3>
            <p>Level up your coding game with our practice resources.</p>
            <button className="cta-btn">Try it free</button>
          </div>
        </div>
      </section>
